...
const DotNetIconSVG: React.FC<ISVGProps> = (props) => {
	return (
		<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 64 64' baseProfile='basic'>
			...
			>
				...
				<stop offset='.699' stopColor='#e492ff' />
			</linearGradient>
			<path fill='url(#dFMIpH0DLBLP_Mye2ctJMa)' d='M19.09,39.37c0,0.01,0.01,0.01,0.01,0.02l-7.7,4.5L19.09,39.37z' />
			<linearGradient
			...
			<path fill='url(#dFMIpH0DLBLP_Mye2ctJMb)' d='M19.09,39.37c0,0.01,0.01,0.01,0.01,0.02	l-7.7,4.5L19.09,39.37z' />
			<linearGradient
			...
			/>
			<linearGradient id='dFMIpH0DLBLP_Mye2ctJMd' x1='32' x2='32' y1='8.058' y2='57.784' gradientUnits='userSpaceOnUse'>
